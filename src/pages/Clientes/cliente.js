          ...
          <Form.Group>  
            ...
            <Row>
              <Col>
                ...
                <DropdownEstados id="estado" name="estado" title="estado" estado={cliente.estado} onChange={(ev) => atualizaEstado(ev.target.value)}></DropdownEstados>
              </Col>
              <Col>
                <Form.Label className="custom-row">Município</Form.Label>
                <DropdownCidades id="municipio" name="municipio" title="municipio" estado={cliente.estado} cidade={cliente.cidade} onChange={(ev) => atualizaCidade(ev.target.value)}></DropdownCidades>
              </Col>
            </Row>
